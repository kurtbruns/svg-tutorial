...
export class OverflowArtboard extends Artboard {
    ...
    drawGrid2(x, y, width, height, border, origin) {
        if (!this._grid) {
     ...
     * ELements.
     */
    drawGrid(border = false, origin = false) {
...
OverflowArtboard.lightStroke = 'var(--light1)';
OverflowArtboard.mediumStroke = 'var(--light2)';
OverflowArtboard.darkStroke = 'var(--light3)';
